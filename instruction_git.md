...
## Отправка изменений в удаленный репохиторий из локального
...
## Скачать изменения из удаленного репохитория в локальный

Для того чтобы скачать изменения в удаленном репохитории в локальный необходимо ввести команду:
